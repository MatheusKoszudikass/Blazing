...
namespace Blazing.infrastructure.Interface
{
    ...
    public interface IProductInfrastructureRepository
    {
        ...
        Task<IEnumerable<ProductDto?>> AddProducts(IEnumerable<ProductDto> productDto);
        ...
        Task<IEnumerable<ProductDto?>> DeleteProducts(IEnumerable<Guid> id);
        ...
        Task<IEnumerable<ProductDto?>> GetProductById(IEnumerable<Guid> id);
        ...
        Task<bool> ExistsAsyncProduct(IEnumerable<ProductDto> productDto);
