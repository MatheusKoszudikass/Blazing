...
public class UserInfrastructureRepository(
    ...
    IUserInfrastructureRepository userInfrastructureRepository) : Repository.IUserInfrastructureRepository
{
    ...
    public async Task<UserCreationResult?> DeleteUsersAsync(IEnumerable<string> id, CancellationToken cancellationToken)
    {
        if (id == null || !id.Any())
            throw DomainException.NotFoundException.FoundException();
    ...
    {
        var resultDto = await _userInfrastructureRepository.GetAllUsers(cancellationToken);
    ...
    /// </summary>
    /// <param name="login.email">The email of the user to log in.</param>
        ...
        CancellationToken cancellationToken)
    {
        ...
        else
        {
            ...
            if (result.IsLockedOut == true)
            {
                ...
                throw UserException.UserLockedOutException.FromLockedOutExceptionUserName(login.Email);
            }
            return result;
        }
