...
namespace Blazing.Test.Infrastructure
{
    ...
    public class RepositoryFixtureTest : IDisposable
    {
        ...
        public UserAppService UserAppServiceIdentity { get; }


        //User Ecommerce

        public UserInfrastructureRepository UserEcommerceRepository { get; }
        ...
        public RepositoryFixtureTest()
        {
            ...
            UserAppServiceIdentity = new UserAppService(Mapper, UserDomainService);

            //UserInfrastructureRepository = new UserInfrastructureRepository(_memoryCache, UserAppServiceIdentity,
            //    InjectServiceIdentityDbContext,
