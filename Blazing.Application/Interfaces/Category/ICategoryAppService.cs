...
namespace Blazing.Application.Interfaces.Category
{
    ...
    public interface ICategoryAppService
    {
        ...
        Task<IEnumerable<CategoryDto?>> AddCategory(IEnumerable<CategoryDto> categoryDtos);
        ...
        Task<IEnumerable<CategoryDto?>> UpdateCategory(IEnumerable<Guid> id, IEnumerable<CategoryDto> categoryDtos);
        ...
        Task<IEnumerable<CategoryDto?>> DeleteCategory(IEnumerable<Guid> id, IEnumerable<CategoryDto?> categoryDtos);
        ...
        Task<IEnumerable<CategoryDto?>> GetById(IEnumerable<Guid> id, IEnumerable<CategoryDto?> categoryDtos);
        /// <summary>
        ...
        Task<IEnumerable<CategoryDto?>> GetAll(IEnumerable<CategoryDto?> categoryDtos);
